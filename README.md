...
Tutorials and examples for working with data at Nesta.
...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so baking_cookies can be imported
    │
    ├── baking_cookies                <- Source code for use in this project.
    │   ├── __init__.py    <- Makes baking_cookies a Python module
    │   │
